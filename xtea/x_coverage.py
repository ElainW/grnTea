...
# YW 2020/07/05 note: defined python class ReadDepth
...
####
    # calc the read depth for one site
    # YW 2020/07/15 clarified m*cov* comments
    def _calc_depth_one_site2(self, record):
        ...
        mlcov = {}  # save the coverage of region to the left of ins_pos, using focal_win
        mrcov = {}  # save the coverage of region to the right of ins_pos, using focal_win
        mlcov2 = {}  # save the coverage of region to the left of ins_pos, using focal_win2
        mrcov2 = {} # save the coverage of region to the right of ins_pos, using focal_win2
        start_pos = insertion_pos - search_win
        if start_pos <= 0:
            start_pos = 1
