...
# YW note, classes defined in this script: BamInfo, LBamInfo (long read), XBamInfo (10X), XAlignment, BarcodeAlignment, OneAlignment
...
####
    ...
    ####given the read name file, return the read falling in the given region
